...
if __name__ == "__main__":
    ...
    required_arguments.add_argument('-t', '--to',
                                    help='recipient of the tweet',
                                    required=True)
    required_arguments.add_argument('-m', '--message', help='message to send',
                                    required=True)
    required_arguments.add_argument('-c', '--config',
